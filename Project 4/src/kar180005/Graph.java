...
public class Graph implements Iterable<Graph.Vertex> {
    ...
    /**
     * Nested class that represents an edge of a kar180005.Graph
     */
	...
	*/
    ...
    /**
     * Constructor for kar180005.Graph
     * 
     * @param n
	...
	System.out.println("kar180005.Graph: n: " + size() + ", m: " + edgeSize() + ", directed: " + directed + ", Edge weights: " + hasEdgeWeights);
	for(Vertex u: this) {
	    System.out.print(u + " : ");
    ...
    // Utilities of kar180005.Graph class:
    /**
     * Find vertex no. n
     * @param n
     *           : int
